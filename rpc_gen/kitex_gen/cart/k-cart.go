...
func (p *GetCartResp) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "cart", thrift.STRUCT, 1)
...
func (p *GetCartResp) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("cart", thrift.STRUCT, 1)
	l += p.Cart.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}
...
func (p *Cart) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "Cart")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *Cart) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("Cart")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *Cart) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "user_id", thrift.I64, 1)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.UserId)
...
func (p *Cart) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
