...
func (p *kCheckOutServiceClient) CheccOut(ctx context.Context, req *check_out.CheckOutReq, callOptions ...callopt.Option) (r *check_out.CheckOutResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CheccOut(ctx, req)
}
