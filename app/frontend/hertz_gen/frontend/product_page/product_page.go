...
func (p *ProductReq) InitDefault() {
}

func (p *ProductReq) GetID() (v int64) {
	return p.ID
}
...
func (p *SearchReq) GetQ() (v string) {
	return p.Q
}
...
type ProductService interface {
	...
	SearchProduct(ctx context.Context, req *SearchReq) (r *common.Empty, err error)
}
...
func (p *ProductServiceClient) SearchProduct(ctx context.Context, req *SearchReq) (r *common.Empty, err error) {
...
var ProductServiceSearchProductArgs_Req_DEFAULT *SearchReq

func (p *ProductServiceSearchProductArgs) GetReq() (v *SearchReq) {
	if !p.IsSetReq() {
...
var ProductServiceSearchProductResult_Success_DEFAULT *common.Empty

func (p *ProductServiceSearchProductResult) GetSuccess() (v *common.Empty) {
	if !p.IsSetSuccess() {
